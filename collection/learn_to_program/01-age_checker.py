'''
	...
	For ages 4 to 6 print go to kindergarten. For ages 7 to 18 tell to go the grade 
	level that is less than from their age by 6. For ages above 18 tell'em to go to collage.
